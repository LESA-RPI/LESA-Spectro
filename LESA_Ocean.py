...
class Ocean:
    ...
    def get_spectrum(self, secs):
        ...
        return spec_inten, self.FLAG_done
    ...
    def get_spectrum_plot(self):
        spec_inten, self.FLAG = self.get_spectrum(1)

        self.plot_graph(self.spec_wave, spec_inten)
        return self.FLAG_done

    # DESC: pause for any amount of time
    # IN: integer number of seconds
    # OUT: program pauses for 'secs' seconds
    def pause(self, secs):
    ...
    def create_file(self):
        ...
        np.savetxt(self.file_name, self.spec_wave, fmt='%10.5f')    # store wave len data
